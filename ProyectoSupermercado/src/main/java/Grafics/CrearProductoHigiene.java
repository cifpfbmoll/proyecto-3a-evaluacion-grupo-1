...
public class CrearProductoHigiene extends javax.swing.JFrame {
    ...
    public CrearProductoHigiene(InterfazUsuario3 frame) {
        initComponents();
        this.setLocationRelativeTo(null);
        this.setVisible(true);
   ...
   @SuppressWarnings("unchecked")
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CrearProductoHigiene.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
