 ...
 * @author PC
 */
public class EscribirIncidencia extends javax.swing.JFrame {

    /**
     * Creates new form EscribirReclamacion
     */
    public EscribirIncidencia() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ESCRIBE LA INCIDENCIA");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EscribirIncidencia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EscribirIncidencia().setVisible(true);
            }
        });
    }
